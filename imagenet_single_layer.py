...
parser.add_argument('--ncnn',  default=7,type=int, help='depth of the CNN')
...
parser.add_argument('--avg_size',  default=14,type=int, help='size of the averaging')
parser.add_argument('--feature_size',  default=512,type=int, help='size of the averaging')
parser.add_argument('--ds',  default=8,type=int, help='downsmapling')
...
parser.add_argument('--prog',  default=0,type=int, help='prog')
parser.add_argument('--debug', default=0,type=int,help='boost')
parser.add_argument('--specialmax', default=0,type=int,help='boost')
parser.add_argument('--large_size_images', default=2,type=int,help='20x20?')
